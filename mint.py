...
w3 = Web3(Web3.HTTPProvider('https://polygon-mainnet.g.alchemy.com/v2/vfCnA0AZ33R_6TshmaQprm_mMnyoGCyI'))
...
pymintscontractaddress = Web3.toChecksumAddress('0x38f93A5AfdDc28A90983c0F318761230Eda21D94')
...
def generate_mintbyid_transaction(from_address, id):
    tx = pymintscontract.functions.mint(int(id)).build_transaction({
        'nonce': str(w3.eth.get_transaction_count(Web3.toChecksumAddress(from_address))),
        "value": str(Web3.toHex(Web3.toWei(0.001, 'ether'))), 
        'gasLimit': '0',
